...
public class StringReverse {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(reverse3("reverse3 =" +str));
        System.out.println(reverse4("reverse4 =" +str));
        System.out.println(reverse5("reverse5 =" +str));
        System.out.println(reverse6("reverse6 =" +str));
        System.out.println(reverse7("reverse7 =" +str));
        System.out.println(reverse8("reverse8 =" +str));
    }
}
